...
- **Onboarding Decision Record**: Added [ADR 012](./ADR/012-automated-contributor-onboarding.md) to document the onboarding infrastructure.

### Changed
- **Documentation Update**: Updated `README.md` and `PLAYBOOK.md` with contributor guidelines and troubleshooting steps for automated workflows.
